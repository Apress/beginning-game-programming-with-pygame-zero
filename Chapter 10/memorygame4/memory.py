...
button_easy = Actor("menu_easy", topleft=(200,100))
button_difficult = Actor("menu_difficult", topleft=(200,250))
button_extreme = Actor("menu_extreme", topleft=(200,400))
...
def on_mouse_down(pos, button):
    ...
    if (game_state.is_new_game()):
        if button_easy.collidepoint(pos):
            ai.difficulty = "easy"
        elif button_difficult.collidepoint(pos):
            ai.difficulty = "difficult"
        elif button_extreme.collidepoint(pos):
...
def draw():
    ...
    if (game_state.is_new_game()):
        screen.draw.text("Choose difficulty", fontsize=60, center=(WIDTH/2,50), shadow=(1,1), color=(255,255,255), scolor="#202020")
        button_easy.draw()
